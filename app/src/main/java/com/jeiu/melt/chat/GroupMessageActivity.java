...
import com.jeiu.melt.model.ChatModel;
import com.jeiu.melt.model.NotificationModel;
...
public class GroupMessageActivity extends AppCompatActivity {
    ...
    void sendGcm(String pushToken) {
        ...
        Request request = new Request.Builder()
                ...
                .addHeader("Authorization","key=AIzaSyBF-OS_HoYQokFryNVqOTaKES3h8Cia-1U")
    ...
    class GroupMessageRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (comments.get(position).uid.equals(uid)) {
                ...
                messageViewHolder.textView_message.setBackgroundResource(R.drawable.rightbubble3);
                ...
                messageViewHolder.textView_message.setBackgroundResource(R.drawable.leftbubble3);
                messageViewHolder.textView_message.setText(comments.get(position).message);
                messageViewHolder.textView_message.setTextSize(16);
